...
async def main():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        # Set up Daily transport with VOICE-ONLY parameters
        transport = DailyTransport(
            ...
            DailyParams(
                ...
                camera_out_enabled=False,  # Disable video output
                camera_in_enabled=False,   # Disable video input
                vad_enabled=True,
        ...
        # Simplified pipeline without RTVI processors
        pipeline = Pipeline(
            [
                transport.input(),
